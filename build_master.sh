...
export MUXEDNAMELONG="Kartal-$MREV-$PLATFORM-$CARRIER-$CURDATE"
export MUXEDNAMESHRT="Kartal-$MREV-$PLATFORM-$CARRIER*"
...
export CROSS_COMPILE=$PARENT_DIR/linaro4.7/bin/arm-gnueabi-
...
make VARIANT_DEFCONFIG=msm8930_serrano_$CARRIER"_defconfig" SELINUX_DEFCONFIG=selinux_defconfig SELINUX_LOG_DEFCONFIG=selinux_log_defconfig kartal_defconfig
